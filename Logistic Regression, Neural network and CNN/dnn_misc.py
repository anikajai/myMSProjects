...
class linear_layer:
    ...
    def forward(self, X):
        ...
        w_tilda = np.insert(self.params['W'], 0,self.params['b'], axis = 0)
        forward_output = np.matmul(x_tilda, w_tilda)
    ...
    def backward(self, X, grad):
        ...
        ##########################################################################################################################
        backward_output = np.matmul(grad,self.params['W'].T) # (inp,out)*(out,1)
